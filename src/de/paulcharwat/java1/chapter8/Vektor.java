...
public class Vektor {
    ...
    public Vektor kreuzprodukt(Vektor dreidimesionaleVektoren) {
        return new Vektor(y + dreidimesionaleVektoren.z - z * dreidimesionaleVektoren.y,
                z * dreidimesionaleVektoren.x - x * dreidimesionaleVektoren.z,
                x * dreidimesionaleVektoren.y - y * dreidimesionaleVektoren.x);
    }
